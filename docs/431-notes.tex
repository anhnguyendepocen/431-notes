...
\hypertarget{the-describe-function-in-the-hmisc-library}{%
\section{\texorpdfstring{The \texttt{describe} function in the \texttt{Hmisc} library}{The describe function in the Hmisc library}}\label{the-describe-function-in-the-hmisc-library}}

The \texttt{Hmisc} library has lots of useful functions. It's named for its main developer, Frank Harrell. The \texttt{describe} function in \texttt{Hmisc} knows enough to separate numerical from categorical variables, and give you separate (and detailed) summaries for each.
