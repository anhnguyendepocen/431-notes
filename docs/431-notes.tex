...
\KeywordTok{library}\NormalTok{(tidymodels) }\CommentTok{# note: tidymodels includes the broom package}
...
\includegraphics{431-notes_files/figure-latex/unnamed-chunk-17-1.pdf}
...
\includegraphics{431-notes_files/figure-latex/unnamed-chunk-18-1.pdf}
...
\NormalTok{sims_kurt <-}\StringTok{ }\KeywordTok{tibble}\NormalTok{(}\DataTypeTok{meso =} \KeywordTok{rnorm}\NormalTok{(}\DataTypeTok{n =} \DecValTok{300}\NormalTok{, }\DataTypeTok{mean =} \DecValTok{0}\NormalTok{, }\DataTypeTok{sd =} \DecValTok{1}\NormalTok{),}
                    \DataTypeTok{lepto =} \KeywordTok{rt}\NormalTok{(}\DataTypeTok{n =} \DecValTok{300}\NormalTok{, }\DataTypeTok{df =} \DecValTok{4}\NormalTok{),}
                    \DataTypeTok{platy =} \KeywordTok{runif}\NormalTok{(}\DataTypeTok{n =} \DecValTok{300}\NormalTok{, }\DataTypeTok{min =} \DecValTok{-2}\NormalTok{, }\DataTypeTok{max =} \DecValTok{2}\NormalTok{))}

\NormalTok{p1 <-}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(sims_kurt, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ meso)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_histogram}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{y =} \KeywordTok{stat}\NormalTok{(density)), }
                 \DataTypeTok{bins =} \DecValTok{25}\NormalTok{, }\DataTypeTok{fill =} \StringTok{"royalblue"}\NormalTok{, }\DataTypeTok{col =} \StringTok{"white"}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{stat_function}\NormalTok{(}\DataTypeTok{fun =}\NormalTok{ dnorm, }
                \DataTypeTok{args =} \KeywordTok{list}\NormalTok{(}\DataTypeTok{mean =} \KeywordTok{mean}\NormalTok{(sims_kurt}\OperatorTok{$}\NormalTok{meso), }
                            \DataTypeTok{sd =} \KeywordTok{sd}\NormalTok{(sims_kurt}\OperatorTok{$}\NormalTok{meso)),}
                \DataTypeTok{col =} \StringTok{"red"}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{title =} \StringTok{"Normal (mesokurtic)"}\NormalTok{)}

\NormalTok{p1a <-}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(sims_kurt, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ meso, }\DataTypeTok{y =} \StringTok{""}\NormalTok{)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_violin}\NormalTok{() }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_boxplot}\NormalTok{(}\DataTypeTok{fill =} \StringTok{"royalblue"}\NormalTok{, }\DataTypeTok{outlier.color =} \StringTok{"royalblue"}\NormalTok{, }\DataTypeTok{width =} \FloatTok{0.3}\NormalTok{)}

\NormalTok{p2 <-}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(sims_kurt, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ lepto)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_histogram}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{y =} \KeywordTok{stat}\NormalTok{(density)), }
                 \DataTypeTok{bins =} \DecValTok{25}\NormalTok{, }\DataTypeTok{fill =} \StringTok{"tomato"}\NormalTok{, }\DataTypeTok{col =} \StringTok{"white"}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{stat_function}\NormalTok{(}\DataTypeTok{fun =}\NormalTok{ dnorm, }
                \DataTypeTok{args =} \KeywordTok{list}\NormalTok{(}\DataTypeTok{mean =} \KeywordTok{mean}\NormalTok{(sims_kurt}\OperatorTok{$}\NormalTok{lepto), }
                            \DataTypeTok{sd =} \KeywordTok{sd}\NormalTok{(sims_kurt}\OperatorTok{$}\NormalTok{lepto)),}
                \DataTypeTok{col =} \StringTok{"royalblue"}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{title =} \StringTok{"t (leptokurtic)"}\NormalTok{)}

\NormalTok{p2a <-}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(sims_kurt, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ lepto, }\DataTypeTok{y =} \StringTok{""}\NormalTok{)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_violin}\NormalTok{() }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_boxplot}\NormalTok{(}\DataTypeTok{fill =} \StringTok{"tomato"}\NormalTok{, }\DataTypeTok{outlier.color =} \StringTok{"tomato"}\NormalTok{, }\DataTypeTok{width =} \FloatTok{0.3}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{y =} \StringTok{""}\NormalTok{, }\DataTypeTok{x =} \StringTok{"t (slender with heavy tails)"}\NormalTok{)}

\NormalTok{p3 <-}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(sims_kurt, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ platy)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_histogram}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{y =} \KeywordTok{stat}\NormalTok{(density)), }
                 \DataTypeTok{bins =} \DecValTok{25}\NormalTok{, }\DataTypeTok{fill =} \StringTok{"yellow"}\NormalTok{, }\DataTypeTok{col =} \StringTok{"black"}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{stat_function}\NormalTok{(}\DataTypeTok{fun =}\NormalTok{ dnorm, }
                \DataTypeTok{args =} \KeywordTok{list}\NormalTok{(}\DataTypeTok{mean =} \KeywordTok{mean}\NormalTok{(sims_kurt}\OperatorTok{$}\NormalTok{platy), }
                            \DataTypeTok{sd =} \KeywordTok{sd}\NormalTok{(sims_kurt}\OperatorTok{$}\NormalTok{platy)),}
                \DataTypeTok{col =} \StringTok{"royalblue"}\NormalTok{, }\DataTypeTok{lwd =} \FloatTok{1.5}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{xlim}\NormalTok{(}\OperatorTok{-}\DecValTok{3}\NormalTok{, }\DecValTok{3}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{title =} \StringTok{"Uniform (platykurtic)"}\NormalTok{)}
...
\includegraphics{431-notes_files/figure-latex/unnamed-chunk-25-1.pdf}
...
\includegraphics{431-notes_files/figure-latex/unnamed-chunk-35-1.pdf}
...
\includegraphics{431-notes_files/figure-latex/unnamed-chunk-40-1.pdf}
...
\includegraphics{431-notes_files/figure-latex/unnamed-chunk-50-1.pdf}
...
\includegraphics{431-notes_files/figure-latex/unnamed-chunk-55-1.pdf}
...
\includegraphics{431-notes_files/figure-latex/unnamed-chunk-56-1.pdf}
...
\includegraphics{431-notes_files/figure-latex/unnamed-chunk-57-1.pdf}
...
\includegraphics{431-notes_files/figure-latex/unnamed-chunk-78-1.pdf}
...
\includegraphics{431-notes_files/figure-latex/unnamed-chunk-79-1.pdf}
...
\includegraphics{431-notes_files/figure-latex/unnamed-chunk-80-1.pdf}
...
\includegraphics{431-notes_files/figure-latex/unnamed-chunk-81-1.pdf}

\hypertarget{straight-line-models-and-correlation}{%
\chapter{Straight Line Models and Correlation}\label{straight-line-models-and-correlation}}

\hypertarget{assessing-a-scatterplot}{%
\section{Assessing A Scatterplot}\label{assessing-a-scatterplot}}
...
\includegraphics{431-notes_files/figure-latex/unnamed-chunk-83-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# identify outlier and place it in data frame s1 }
\NormalTok{s1 <-}\StringTok{ }\KeywordTok{filter}\NormalTok{(nnyfs, protein }\OperatorTok{>}\StringTok{ }\DecValTok{190} \OperatorTok{&}\StringTok{ }\NormalTok{fat }\OperatorTok{<}\StringTok{ }\DecValTok{100}\NormalTok{)}
...
\StringTok{    }\KeywordTok{theme_bw}\NormalTok{() }\OperatorTok{+}
\StringTok{    }\KeywordTok{geom_point}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ s1, }\DataTypeTok{size =} \DecValTok{2}\NormalTok{, }\DataTypeTok{col =} \StringTok{"red"}\NormalTok{) }\OperatorTok{+}
\StringTok{    }\KeywordTok{geom_text}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ s1, }\DataTypeTok{label =}\NormalTok{ s1}\OperatorTok{$}\NormalTok{SEQN, }
              \DataTypeTok{vjust =} \DecValTok{-1}\NormalTok{, }\DataTypeTok{col =} \StringTok{"red"}\NormalTok{) }\OperatorTok{+}
\StringTok{    }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{title =} \StringTok{"Protein vs. Fat consumption in NNYFS"}\NormalTok{,}
         \DataTypeTok{subtitle =} \StringTok{"with regression line, and an outlier labeled by SEQN"}\NormalTok{,}
         \DataTypeTok{x =} \StringTok{"Protein (in g)"}\NormalTok{, }\DataTypeTok{y =} \StringTok{"Fat (in g)"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{431-notes_files/figure-latex/unnamed-chunk-84-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{s1 }\OperatorTok{%>%}\StringTok{ }\KeywordTok{select}\NormalTok{(SEQN, sex, race_eth, age_child, protein, fat) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{kable}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{431-notes_files/figure-latex/unnamed-chunk-86-1.pdf}
...
\includegraphics{431-notes_files/figure-latex/unnamed-chunk-87-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{tidy}\NormalTok{(}\KeywordTok{lm}\NormalTok{(fat }\OperatorTok{~}\StringTok{ }\NormalTok{protein, }\DataTypeTok{data =}\NormalTok{ nnyfs),}
            \DataTypeTok{conf.int =} \OtherTok{TRUE}\NormalTok{, }\DataTypeTok{conf.level =} \FloatTok{0.95}\NormalTok{) }\OperatorTok{%>%}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{glance}\NormalTok{(}\KeywordTok{lm}\NormalTok{(fat }\OperatorTok{~}\StringTok{ }\NormalTok{protein, }\DataTypeTok{data =}\NormalTok{ nnyfs)) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{select}\NormalTok{(r.squared) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{kable}\NormalTok{(}\DataTypeTok{digits =} \DecValTok{3}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{nnyfs }\OperatorTok{%$%}\StringTok{ }\KeywordTok{cor}\NormalTok{(fat, protein)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{431-notes_files/figure-latex/unnamed-chunk-94-1.pdf}
...
\includegraphics{431-notes_files/figure-latex/unnamed-chunk-95-1.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{setA <-}\StringTok{ }\KeywordTok{filter}\NormalTok{(correx1, set }\OperatorTok{==}\StringTok{ "Alex"}\NormalTok{)}

\KeywordTok{ggplot}\NormalTok{(setA, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ x, }\DataTypeTok{y =}\NormalTok{ y)) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{geom_point}\NormalTok{() }\OperatorTok{+}
...
\StringTok{    }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{title =} \StringTok{"correx1: Alex, with Fitted Linear Model"}\NormalTok{) }\OperatorTok{+}
\StringTok{    }\KeywordTok{annotate}\NormalTok{(}\StringTok{"text"}\NormalTok{, }\DataTypeTok{x =} \DecValTok{75}\NormalTok{, }\DataTypeTok{y =} \DecValTok{75}\NormalTok{, }\DataTypeTok{col =} \StringTok{"purple"}\NormalTok{, }\DataTypeTok{size =} \DecValTok{6}\NormalTok{,}
             \DataTypeTok{label =} \KeywordTok{paste}\NormalTok{(}\StringTok{"Pearson r = "}\NormalTok{, }\KeywordTok{signif}\NormalTok{(}\KeywordTok{cor}\NormalTok{(setA}\OperatorTok{$}\NormalTok{x, setA}\OperatorTok{$}\NormalTok{y),}\DecValTok{3}\NormalTok{))) }\OperatorTok{+}
\StringTok{    }\KeywordTok{annotate}\NormalTok{(}\StringTok{"text"}\NormalTok{, }\DataTypeTok{x =} \DecValTok{50}\NormalTok{, }\DataTypeTok{y =} \DecValTok{15}\NormalTok{,  }\DataTypeTok{col =} \StringTok{"red"}\NormalTok{, }\DataTypeTok{size =} \DecValTok{5}\NormalTok{,}
             \DataTypeTok{label =} \KeywordTok{paste}\NormalTok{(}\StringTok{"y = "}\NormalTok{, }\KeywordTok{signif}\NormalTok{(}\KeywordTok{coef}\NormalTok{(}\KeywordTok{lm}\NormalTok{(setA}\OperatorTok{$}\NormalTok{y }\OperatorTok{~}\StringTok{ }\NormalTok{setA}\OperatorTok{$}\NormalTok{x))[}\DecValTok{1}\NormalTok{],}\DecValTok{3}\NormalTok{), }
                           \KeywordTok{signif}\NormalTok{(}\KeywordTok{coef}\NormalTok{(}\KeywordTok{lm}\NormalTok{(setA}\OperatorTok{$}\NormalTok{y }\OperatorTok{~}\StringTok{ }\NormalTok{setA}\OperatorTok{$}\NormalTok{x))[}\DecValTok{2}\NormalTok{],}\DecValTok{2}\NormalTok{), }\StringTok{"x"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}

\includegraphics{431-notes_files/figure-latex/unnamed-chunk-96-1.pdf}

\hypertarget{data-set-bonnie}{%
\subsection{Data Set Bonnie}\label{data-set-bonnie}}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{setB <-}\StringTok{ }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{filter}\NormalTok{(correx1, set }\OperatorTok{==}\StringTok{ "Bonnie"}\NormalTok{)}

\KeywordTok{ggplot}\NormalTok{(setB, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ x, }\DataTypeTok{y =}\NormalTok{ y)) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{geom_point}\NormalTok{() }\OperatorTok{+}
\StringTok{    }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{title =} \StringTok{"correx1: Data Set Bonnie"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{431-notes_files/figure-latex/unnamed-chunk-97-1.pdf}
...
\StringTok{    }\KeywordTok{geom_point}\NormalTok{() }\OperatorTok{+}
\StringTok{    }\KeywordTok{geom_smooth}\NormalTok{(}\DataTypeTok{method =} \StringTok{"lm"}\NormalTok{, }\DataTypeTok{col =} \StringTok{"red"}\NormalTok{) }\OperatorTok{+}
\StringTok{    }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{title =} \StringTok{"correx1: Bonnie, with Fitted Linear Model"}\NormalTok{) }\OperatorTok{+}
\StringTok{    }\KeywordTok{annotate}\NormalTok{(}\StringTok{"text"}\NormalTok{, }\DataTypeTok{x =} \DecValTok{25}\NormalTok{, }\DataTypeTok{y =} \DecValTok{65}\NormalTok{, }\DataTypeTok{col =} \StringTok{"purple"}\NormalTok{, }\DataTypeTok{size =} \DecValTok{6}\NormalTok{,}
             \DataTypeTok{label =} \KeywordTok{paste}\NormalTok{(}\StringTok{"Pearson r = "}\NormalTok{, }\KeywordTok{signif}\NormalTok{(}\KeywordTok{cor}\NormalTok{(setB}\OperatorTok{$}\NormalTok{x, setB}\OperatorTok{$}\NormalTok{y),}\DecValTok{2}\NormalTok{))) }\OperatorTok{+}
\StringTok{    }\KeywordTok{annotate}\NormalTok{(}\StringTok{"text"}\NormalTok{, }\DataTypeTok{x =} \DecValTok{50}\NormalTok{, }\DataTypeTok{y =} \DecValTok{15}\NormalTok{,  }\DataTypeTok{col =} \StringTok{"red"}\NormalTok{, }\DataTypeTok{size =} \DecValTok{5}\NormalTok{,}
             \DataTypeTok{label =} \KeywordTok{paste}\NormalTok{(}\StringTok{"y = "}\NormalTok{, }\KeywordTok{signif}\NormalTok{(}\KeywordTok{coef}\NormalTok{(}\KeywordTok{lm}\NormalTok{(setB}\OperatorTok{$}\NormalTok{y }\OperatorTok{~}\StringTok{ }\NormalTok{setB}\OperatorTok{$}\NormalTok{x))[}\DecValTok{1}\NormalTok{],}\DecValTok{3}\NormalTok{), }
                           \StringTok{" + "}\NormalTok{,}
                           \KeywordTok{signif}\NormalTok{(}\KeywordTok{coef}\NormalTok{(}\KeywordTok{lm}\NormalTok{(setB}\OperatorTok{$}\NormalTok{y }\OperatorTok{~}\StringTok{ }\NormalTok{setB}\OperatorTok{$}\NormalTok{x))[}\DecValTok{2}\NormalTok{],}\DecValTok{2}\NormalTok{), }\StringTok{"x"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}

\includegraphics{431-notes_files/figure-latex/unnamed-chunk-98-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{tab1 <-}\StringTok{ }\NormalTok{correx1 }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{group_by}\NormalTok{(set) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{summarise}\NormalTok{(}\StringTok{"Pearson r"}\NormalTok{ =}\StringTok{ }\KeywordTok{round}\NormalTok{(}\KeywordTok{cor}\NormalTok{(x, y, }\DataTypeTok{use=}\StringTok{"complete"}\NormalTok{),}\DecValTok{2}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{431-notes_files/figure-latex/unnamed-chunk-100-1.pdf}
...
\includegraphics{431-notes_files/figure-latex/unnamed-chunk-101-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{correx2 }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{group_by}\NormalTok{(set) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{summarise}\NormalTok{(}\DataTypeTok{cor =} \KeywordTok{round}\NormalTok{(}\KeywordTok{cor}\NormalTok{(x, y, }\DataTypeTok{use=}\StringTok{"complete"}\NormalTok{),}\DecValTok{3}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{431-notes_files/figure-latex/unnamed-chunk-104-1.pdf}
...
\includegraphics{431-notes_files/figure-latex/unnamed-chunk-105-1.pdf}
...
\includegraphics{431-notes_files/figure-latex/unnamed-chunk-106-1.pdf}
...
\includegraphics{431-notes_files/figure-latex/unnamed-chunk-107-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{nnyfs }\OperatorTok{%$%}\StringTok{ }\KeywordTok{cor}\NormalTok{(fat, protein, }\DataTypeTok{method =} \StringTok{"spearman"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{ggplot}\NormalTok{(spear1, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ x, }\DataTypeTok{y =}\NormalTok{ y)) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{geom_point}\NormalTok{() }\OperatorTok{+}
\StringTok{    }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{title =} \StringTok{"Spearman vs. Pearson, Example 1"}\NormalTok{) }\OperatorTok{+}
\StringTok{    }\KeywordTok{annotate}\NormalTok{(}\StringTok{"text"}\NormalTok{, }\DataTypeTok{x =} \DecValTok{-10}\NormalTok{, }\DataTypeTok{y =} \DecValTok{20}\NormalTok{, }
             \DataTypeTok{label =} \KeywordTok{paste}\NormalTok{(}\StringTok{"Pearson r = "}\NormalTok{, }
                 \KeywordTok{signif}\NormalTok{(}\KeywordTok{cor}\NormalTok{(spear1}\OperatorTok{$}\NormalTok{x, spear1}\OperatorTok{$}\NormalTok{y),}\DecValTok{2}\NormalTok{),}
                 \StringTok{", Spearman r = "}\NormalTok{, }
                 \KeywordTok{signif}\NormalTok{(}\KeywordTok{cor}\NormalTok{(spear1}\OperatorTok{$}\NormalTok{x, spear1}\OperatorTok{$}\NormalTok{y, }\DataTypeTok{method =} \StringTok{"spearman"}\NormalTok{),}\DecValTok{2}\NormalTok{)))}
\end{Highlighting}
\end{Shaded}

\includegraphics{431-notes_files/figure-latex/spearex1-fig-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{ggplot}\NormalTok{(spear2, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ x, }\DataTypeTok{y =}\NormalTok{ y)) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{geom_point}\NormalTok{(}\DataTypeTok{col =} \StringTok{"purple"}\NormalTok{) }\OperatorTok{+}
...
\StringTok{    }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{title =} \StringTok{"Spearman vs. Pearson, Example 2"}\NormalTok{) }\OperatorTok{+}
\StringTok{    }\KeywordTok{annotate}\NormalTok{(}\StringTok{"text"}\NormalTok{, }\DataTypeTok{x =} \DecValTok{10}\NormalTok{, }\DataTypeTok{y =} \DecValTok{20}\NormalTok{, }\DataTypeTok{col =} \StringTok{"purple"}\NormalTok{,}
             \DataTypeTok{label =} \KeywordTok{paste}\NormalTok{(}\StringTok{"Pearson r = "}\NormalTok{, }
                    \KeywordTok{signif}\NormalTok{(}\KeywordTok{cor}\NormalTok{(spear2}\OperatorTok{$}\NormalTok{x, spear2}\OperatorTok{$}\NormalTok{y),}\DecValTok{2}\NormalTok{),}
                    \StringTok{", Spearman r = "}\NormalTok{, }
                    \KeywordTok{signif}\NormalTok{(}\KeywordTok{cor}\NormalTok{(spear2}\OperatorTok{$}\NormalTok{x, spear2}\OperatorTok{$}\NormalTok{y, }\DataTypeTok{method =} \StringTok{"spearman"}\NormalTok{),}\DecValTok{2}\NormalTok{)))}
\end{Highlighting}
\end{Shaded}

\includegraphics{431-notes_files/figure-latex/spearex2-fig-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{ggplot}\NormalTok{(spear3, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ x, }\DataTypeTok{y =}\NormalTok{ y)) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{geom_point}\NormalTok{(}\DataTypeTok{col =} \StringTok{"blue"}\NormalTok{) }\OperatorTok{+}
\StringTok{    }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{title =} \StringTok{"Spearman vs. Pearson, Example 3"}\NormalTok{) }\OperatorTok{+}
\StringTok{    }\KeywordTok{annotate}\NormalTok{(}\StringTok{"text"}\NormalTok{, }\DataTypeTok{x =} \DecValTok{5}\NormalTok{, }\DataTypeTok{y =} \DecValTok{-15}\NormalTok{, }\DataTypeTok{col =} \StringTok{"blue"}\NormalTok{,}
             \DataTypeTok{label =} \KeywordTok{paste}\NormalTok{(}\StringTok{"Pearson r = "}\NormalTok{, }
                \KeywordTok{signif}\NormalTok{(}\KeywordTok{cor}\NormalTok{(spear3}\OperatorTok{$}\NormalTok{x, spear3}\OperatorTok{$}\NormalTok{y),}\DecValTok{2}\NormalTok{),}
                \StringTok{", Spearman r = "}\NormalTok{, }
                \KeywordTok{signif}\NormalTok{(}\KeywordTok{cor}\NormalTok{(spear3}\OperatorTok{$}\NormalTok{x, spear3}\OperatorTok{$}\NormalTok{y, }\DataTypeTok{method =} \StringTok{"spearman"}\NormalTok{),}\DecValTok{2}\NormalTok{)))}
\end{Highlighting}
\end{Shaded}

\includegraphics{431-notes_files/figure-latex/spearex3-fig-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{ggplot}\NormalTok{(spear4, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ x, }\DataTypeTok{y =}\NormalTok{ y)) }\OperatorTok{+}
\StringTok{    }\KeywordTok{geom_point}\NormalTok{(}\DataTypeTok{col =} \StringTok{"purple"}\NormalTok{) }\OperatorTok{+}
\StringTok{    }\KeywordTok{geom_smooth}\NormalTok{(}\DataTypeTok{method =} \StringTok{"loess"}\NormalTok{, }\DataTypeTok{se =} \OtherTok{FALSE}\NormalTok{) }\OperatorTok{+}
\StringTok{    }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{title =} \StringTok{"Spearman vs. Pearson, Example 4"}\NormalTok{) }\OperatorTok{+}
\StringTok{    }\KeywordTok{annotate}\NormalTok{(}\StringTok{"text"}\NormalTok{, }\DataTypeTok{x =} \DecValTok{10}\NormalTok{, }\DataTypeTok{y =} \DecValTok{20}\NormalTok{, }\DataTypeTok{col =} \StringTok{"purple"}\NormalTok{,}
             \DataTypeTok{label =} \KeywordTok{paste}\NormalTok{(}\StringTok{"Pearson r = "}\NormalTok{, }
                 \KeywordTok{signif}\NormalTok{(}\KeywordTok{cor}\NormalTok{(spear4}\OperatorTok{$}\NormalTok{x, spear4}\OperatorTok{$}\NormalTok{y),}\DecValTok{2}\NormalTok{),}
                 \StringTok{", Spearman r = "}\NormalTok{, }
                 \KeywordTok{signif}\NormalTok{(}\KeywordTok{cor}\NormalTok{(spear4}\OperatorTok{$}\NormalTok{x, spear4}\OperatorTok{$}\NormalTok{y, }\DataTypeTok{method =} \StringTok{"spearman"}\NormalTok{),}\DecValTok{2}\NormalTok{)))}
\end{Highlighting}
\end{Shaded}

\includegraphics{431-notes_files/figure-latex/spearex4-fig-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{crabs }\OperatorTok{%>%}\StringTok{ }\KeywordTok{tabyl}\NormalTok{(species)}
\end{Highlighting}
\end{Shaded}
...
\StringTok{    }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{species =} \KeywordTok{factor}\NormalTok{(species))}
\end{Highlighting}
\end{Shaded}
...
\StringTok{    }\KeywordTok{summarise}\NormalTok{(}\DataTypeTok{n =} \KeywordTok{n}\NormalTok{(), }\KeywordTok{median}\NormalTok{(force), }\KeywordTok{median}\NormalTok{(height))}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{431-notes_files/figure-latex/crabsscatter1-fig-1.pdf}
...
\includegraphics{431-notes_files/figure-latex/crabsscatter2-fig-1.pdf}
...
\includegraphics{431-notes_files/figure-latex/crabsscatter4-fig-1.pdf}
...
\includegraphics{431-notes_files/figure-latex/crabsscatter5-fig-1.pdf}
...
\includegraphics{431-notes_files/figure-latex/crabsscatter6-fig-1.pdf}
...
\KeywordTok{ggplot}\NormalTok{(crabs, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ height, }\DataTypeTok{y =}\NormalTok{ force, }\DataTypeTok{group =}\NormalTok{ species, }\DataTypeTok{color =}\NormalTok{ species)) }\OperatorTok{+}
\StringTok{    }\KeywordTok{geom_point}\NormalTok{() }\OperatorTok{+}
\StringTok{    }\KeywordTok{stat_smooth}\NormalTok{(}\DataTypeTok{method =} \StringTok{"loess"}\NormalTok{, }\DataTypeTok{formula =}\NormalTok{ y }\OperatorTok{~}\StringTok{ }\NormalTok{x, }\DataTypeTok{level =} \FloatTok{0.90}\NormalTok{, }\DataTypeTok{se =} \OtherTok{TRUE}\NormalTok{) }\OperatorTok{+}
\StringTok{    }\KeywordTok{guides}\NormalTok{(}\DataTypeTok{color =} \OtherTok{FALSE}\NormalTok{) }\OperatorTok{+}
\StringTok{    }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{title =} \StringTok{"Crab Claw Force by Size"}\NormalTok{, }
         \DataTypeTok{caption =} \StringTok{"with loess smooths and 90% confidence intervals"}\NormalTok{,}
         \DataTypeTok{x =} \StringTok{"Claw's propodus height (mm)"}\NormalTok{, }\DataTypeTok{y =} \StringTok{"Mean closing force (N)"}\NormalTok{) }\OperatorTok{+}
\StringTok{    }\KeywordTok{facet_wrap}\NormalTok{(}\OperatorTok{~}\StringTok{ }\NormalTok{species)}
\end{Highlighting}
\end{Shaded}

\includegraphics{431-notes_files/figure-latex/crabsscatter7-fig-1.pdf}
...
\includegraphics{431-notes_files/figure-latex/crabsscatter8-fig-1.pdf}
...
\includegraphics{431-notes_files/figure-latex/crabs_loglog_model1-fig-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{loglogdat <-}\StringTok{ }\KeywordTok{tibble}\NormalTok{(}\DataTypeTok{height =}\NormalTok{ crabs}\OperatorTok{$}\NormalTok{height, }\DataTypeTok{force =} \KeywordTok{exp}\NormalTok{(}\KeywordTok{predict}\NormalTok{(crab_loglog)))}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{431-notes_files/figure-latex/crabsmodelcompare-fig-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{res <-}\StringTok{ }\NormalTok{mosaic}\OperatorTok{::}\KeywordTok{favstats}\NormalTok{(}\OperatorTok{~}\StringTok{ }\NormalTok{sbp, }\DataTypeTok{data =}\NormalTok{ wcgs)}
\NormalTok{bin_w <-}\StringTok{ }\DecValTok{5} \CommentTok{# specify binwidth}

\KeywordTok{ggplot}\NormalTok{(wcgs, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ sbp)) }\OperatorTok{+}
\StringTok{    }\KeywordTok{geom_histogram}\NormalTok{(}\DataTypeTok{binwidth =}\NormalTok{ bin_w, }
                   \DataTypeTok{fill =} \StringTok{"orchid"}\NormalTok{, }
                   \DataTypeTok{col =} \StringTok{"blue"}\NormalTok{) }\OperatorTok{+}
\StringTok{    }\KeywordTok{stat_function}\NormalTok{(}
...
\StringTok{            }\NormalTok{res}\OperatorTok{$}\NormalTok{n }\OperatorTok{*}\StringTok{ }\NormalTok{bin_w,}
        \DataTypeTok{col =} \StringTok{"navy"}\NormalTok{) }\OperatorTok{+}
\StringTok{    }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{title =} \StringTok{"Systolic BP for `wcgs` subjects"}\NormalTok{,}
     \DataTypeTok{x =} \StringTok{"Systolic BP (mm Hg)"}\NormalTok{, }\DataTypeTok{y =} \StringTok{""}\NormalTok{,}
     \DataTypeTok{caption =} \StringTok{"Superimposed Normal model"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{431-notes_files/figure-latex/unnamed-chunk-116-1.pdf}

Since the data contain both \texttt{sbp} and \texttt{lnsbp} (its natural logarithm), let's compare them. Note that in preparing the graph, we'll need to change the location for the text annotation.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{res <-}\StringTok{ }\NormalTok{mosaic}\OperatorTok{::}\KeywordTok{favstats}\NormalTok{(}\OperatorTok{~}\StringTok{ }\NormalTok{lnsbp, }\DataTypeTok{data =}\NormalTok{ wcgs)}
\NormalTok{bin_w <-}\StringTok{ }\FloatTok{0.05} \CommentTok{# specify binwidth}

\KeywordTok{ggplot}\NormalTok{(wcgs, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ lnsbp)) }\OperatorTok{+}
\StringTok{    }\KeywordTok{geom_histogram}\NormalTok{(}\DataTypeTok{binwidth =}\NormalTok{ bin_w, }
...
\StringTok{            }\NormalTok{res}\OperatorTok{$}\NormalTok{n }\OperatorTok{*}\StringTok{ }\NormalTok{bin_w,}
        \DataTypeTok{col =} \StringTok{"navy"}\NormalTok{) }\OperatorTok{+}
\StringTok{    }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{title =} \StringTok{"ln(Systolic BP) for `wcgs` subjects"}\NormalTok{,}
     \DataTypeTok{x =} \StringTok{"ln(Systolic BP)"}\NormalTok{, }\DataTypeTok{y =} \StringTok{""}\NormalTok{,}
     \DataTypeTok{caption =} \StringTok{"Superimposed Normal model"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{431-notes_files/figure-latex/unnamed-chunk-117-1.pdf}

We can also look at Normal Q-Q plots, for instance\ldots{}
...
\includegraphics{431-notes_files/figure-latex/wcgs_qqplotsforsbpandlnsbpfromggplot-fig-1.pdf}
...
\includegraphics{431-notes_files/figure-latex/unnamed-chunk-118-1.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{wcgs }\OperatorTok{%$%}\StringTok{ }\NormalTok{Hmisc}\OperatorTok{::}\KeywordTok{describe}\NormalTok{(sbp)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{431-notes_files/figure-latex/wcgssbpbyweightbox-fig-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{wcgs }\OperatorTok{%>%}\StringTok{ }\KeywordTok{tabyl}\NormalTok{(wghtcat)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{wcgs <-}\StringTok{ }\NormalTok{wcgs }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{weight_f =} \KeywordTok{fct_relevel}\NormalTok{(wghtcat, }\StringTok{"< 140"}\NormalTok{, }\StringTok{"140-170"}\NormalTok{, }\StringTok{"170-200"}\NormalTok{, }\StringTok{"> 200"}\NormalTok{))}

\NormalTok{wcgs }\OperatorTok{%>%}\StringTok{ }\KeywordTok{tabyl}\NormalTok{(weight_f)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{431-notes_files/figure-latex/wcgssbpbyweightboxrevised-fig-1.pdf}
...
\StringTok{    }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ sbp, }\DataTypeTok{y =}\NormalTok{ weight_f, }\DataTypeTok{fill =}\NormalTok{ weight_f, }\DataTypeTok{height =}\NormalTok{ ..density..)) }\OperatorTok{+}
\StringTok{    }\NormalTok{ggridges}\OperatorTok{::}\KeywordTok{geom_density_ridges}\NormalTok{(}\DataTypeTok{scale =} \DecValTok{2}\NormalTok{) }\OperatorTok{+}
\StringTok{    }\KeywordTok{scale_fill_viridis_d}\NormalTok{() }\OperatorTok{+}
\StringTok{    }\KeywordTok{guides}\NormalTok{(}\DataTypeTok{fill =} \OtherTok{FALSE}\NormalTok{) }\OperatorTok{+}
\StringTok{    }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{title =} \StringTok{"SBP by Weight Category (wcgs)"}\NormalTok{,}
         \DataTypeTok{x =} \StringTok{"Systolic Blood Pressure"}\NormalTok{,}
         \DataTypeTok{y =} \StringTok{"Weight Category"}\NormalTok{) }\OperatorTok{+}
\StringTok{    }\KeywordTok{theme_bw}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{431-notes_files/figure-latex/wcgs_sbp_by_weight_f_ridgelineplot-1.pdf}
...
\includegraphics{431-notes_files/figure-latex/unnamed-chunk-121-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{wcgs }\OperatorTok{%>%}\StringTok{ }\KeywordTok{tabyl}\NormalTok{(arcus)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{wcgs <-}\StringTok{ }\NormalTok{wcgs }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{arcus_f =} \KeywordTok{fct_recode}\NormalTok{(}\KeywordTok{factor}\NormalTok{(arcus),}
                                \StringTok{"Arcus senilis"}\NormalTok{ =}\StringTok{ "1"}\NormalTok{,}
                                \StringTok{"No arcus senilis"}\NormalTok{ =}\StringTok{ "0"}\NormalTok{),}
           \DataTypeTok{arcus_f =} \KeywordTok{fct_relevel}\NormalTok{(arcus_f, }\StringTok{"Arcus senilis"}\NormalTok{))}

\NormalTok{wcgs }\OperatorTok{%>%}\StringTok{ }\KeywordTok{tabyl}\NormalTok{(arcus_f, arcus)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{wcgs }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{filter}\NormalTok{(}\KeywordTok{complete.cases}\NormalTok{(arcus_f, sbp, weight)) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ weight, }\DataTypeTok{y =}\NormalTok{ sbp, }\DataTypeTok{group =}\NormalTok{ arcus_f)) }\OperatorTok{+}
\StringTok{    }\KeywordTok{geom_point}\NormalTok{(}\DataTypeTok{shape =} \DecValTok{1}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{stat_smooth}\NormalTok{(}\DataTypeTok{method=}\NormalTok{lm, }\DataTypeTok{color=}\StringTok{"red"}\NormalTok{) }\OperatorTok{+}
\StringTok{    }\KeywordTok{stat_smooth}\NormalTok{(}\DataTypeTok{method=}\NormalTok{loess, }\DataTypeTok{se=}\OtherTok{FALSE}\NormalTok{, }\DataTypeTok{color=}\StringTok{"blue"}\NormalTok{) }\OperatorTok{+}
\StringTok{    }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{title =} \StringTok{"SBP vs. Weight by Arcus Senilis status"}\NormalTok{,}
         \DataTypeTok{caption =} \StringTok{"3,152 Western Collaborative Group Study subjects with known arcus senilis status"}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{facet_wrap}\NormalTok{(}\OperatorTok{~}\StringTok{ }\NormalTok{arcus_f) }\OperatorTok{+}
\StringTok{    }\KeywordTok{theme_bw}\NormalTok{()}
\end{Highlighting}
\end{Shaded}

\includegraphics{431-notes_files/figure-latex/unnamed-chunk-123-1.pdf}

\hypertarget{linear-model-for-sbp-weight-relationship-subjects-without-arcus-senilis}{%
\section{Linear Model for SBP-Weight Relationship: subjects without Arcus Senilis}\label{linear-model-for-sbp-weight-relationship-subjects-without-arcus-senilis}}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{model.noarcus <-}\StringTok{ }
\StringTok{    }\KeywordTok{lm}\NormalTok{(sbp }\OperatorTok{~}\StringTok{ }\NormalTok{weight, }\DataTypeTok{data =} \KeywordTok{filter}\NormalTok{(wcgs, arcus }\OperatorTok{==}\StringTok{ }\DecValTok{0}\NormalTok{))}

\KeywordTok{tidy}\NormalTok{(model.noarcus) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{kable}\NormalTok{(}\DataTypeTok{digits =} \DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{glance}\NormalTok{(model.noarcus) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{select}\NormalTok{(r.squared}\OperatorTok{:}\NormalTok{p.value, AIC) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{kable}\NormalTok{(}\DataTypeTok{digits =} \DecValTok{3}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{model.witharcus <-}\StringTok{ }
\StringTok{    }\KeywordTok{lm}\NormalTok{(sbp }\OperatorTok{~}\StringTok{ }\NormalTok{weight, }\DataTypeTok{data =} \KeywordTok{filter}\NormalTok{(wcgs, arcus }\OperatorTok{==}\StringTok{ }\DecValTok{1}\NormalTok{))}

\KeywordTok{tidy}\NormalTok{(model.witharcus) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{kable}\NormalTok{(}\DataTypeTok{digits =} \DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{glance}\NormalTok{(model.witharcus) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{select}\NormalTok{(r.squared}\OperatorTok{:}\NormalTok{p.value, AIC) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{kable}\NormalTok{(}\DataTypeTok{digits =} \DecValTok{3}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{model3 <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(sbp }\OperatorTok{~}\StringTok{ }\NormalTok{weight }\OperatorTok{*}\StringTok{ }\NormalTok{arcus, }\DataTypeTok{data =} \KeywordTok{filter}\NormalTok{(wcgs, }\OperatorTok{!}\KeywordTok{is.na}\NormalTok{(arcus)))}

\KeywordTok{tidy}\NormalTok{(model3) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{kable}\NormalTok{(}\DataTypeTok{digits =} \DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{glance}\NormalTok{(model3) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{select}\NormalTok{(r.squared}\OperatorTok{:}\NormalTok{p.value, AIC) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{kable}\NormalTok{(}\DataTypeTok{digits =} \DecValTok{3}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{431-notes_files/figure-latex/unnamed-chunk-127-1.pdf}
...
\includegraphics{431-notes_files/figure-latex/unnamed-chunk-128-1.pdf}
...
\begin{Highlighting}[]
\NormalTok{wcgs }\OperatorTok{%>%}
\StringTok{    }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{select}\NormalTok{(sbp, age, weight, height) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{cor}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }\CommentTok{# obtain correlation coefficients for this subgroup}
\StringTok{    }\KeywordTok{signif}\NormalTok{(., }\DecValTok{3}\NormalTok{) }\CommentTok{# round them off to three significant figures before printing}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{GGally}\OperatorTok{::}\KeywordTok{ggpairs}\NormalTok{(wcgs }\OperatorTok{%>%}\StringTok{ }\KeywordTok{select}\NormalTok{(sbp, age, weight, height), }
                \DataTypeTok{title =} \StringTok{"Scatterplot Matrix via ggpairs"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{431-notes_files/figure-latex/unnamed-chunk-130-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{set.seed}\NormalTok{(}\DecValTok{999}\NormalTok{); x.rand <-}\StringTok{ }\KeywordTok{rbeta}\NormalTok{(}\DecValTok{80}\NormalTok{, }\DecValTok{2}\NormalTok{, }\DecValTok{5}\NormalTok{) }\OperatorTok{*}\StringTok{ }\DecValTok{20} \OperatorTok{+}\StringTok{ }\DecValTok{3}
\KeywordTok{set.seed}\NormalTok{(}\DecValTok{1000}\NormalTok{); y.rand <-}\StringTok{ }\KeywordTok{abs}\NormalTok{(}\DecValTok{50} \OperatorTok{+}\StringTok{ }\FloatTok{0.75}\OperatorTok{*}\NormalTok{x.rand}\OperatorTok{^}\NormalTok{(}\DecValTok{3}\NormalTok{) }\OperatorTok{-}\StringTok{ }\FloatTok{0.65}\OperatorTok{*}\NormalTok{x.rand }\OperatorTok{+}\StringTok{ }\KeywordTok{rnorm}\NormalTok{(}\DecValTok{80}\NormalTok{, }\DecValTok{0}\NormalTok{, }\DecValTok{200}\NormalTok{))}
\NormalTok{scatter1 <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ x.rand, }\DataTypeTok{y =}\NormalTok{ y.rand) }\OperatorTok{%>%}\StringTok{ }\NormalTok{tbl_df}
\KeywordTok{rm}\NormalTok{(x.rand, y.rand)}

\KeywordTok{ggplot}\NormalTok{(scatter1, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ x, }\DataTypeTok{y =}\NormalTok{ y)) }\OperatorTok{+}
\StringTok{    }\KeywordTok{geom_point}\NormalTok{(}\DataTypeTok{shape =} \DecValTok{1}\NormalTok{, }\DataTypeTok{size =} \DecValTok{3}\NormalTok{) }\OperatorTok{+}
\StringTok{    }\CommentTok{## add loess smooth}
\StringTok{    }\KeywordTok{geom_smooth}\NormalTok{(}\DataTypeTok{method =} \StringTok{"loess"}\NormalTok{, }\DataTypeTok{se =} \OtherTok{FALSE}\NormalTok{, }
                \DataTypeTok{col =} \StringTok{"dodgerblue"}\NormalTok{, }\DataTypeTok{formula =}\NormalTok{ y }\OperatorTok{~}\StringTok{ }\NormalTok{x) }\OperatorTok{+}
\StringTok{    }\CommentTok{## then add linear fit}
\StringTok{    }\KeywordTok{geom_smooth}\NormalTok{(}\DataTypeTok{method =} \StringTok{"lm"}\NormalTok{, }\DataTypeTok{se =} \OtherTok{FALSE}\NormalTok{, }
                \DataTypeTok{col =} \StringTok{"red"}\NormalTok{, }\DataTypeTok{formula =}\NormalTok{ y }\OperatorTok{~}\StringTok{ }\NormalTok{x, }\DataTypeTok{linetype =} \StringTok{"dashed"}\NormalTok{) }\OperatorTok{+}
\StringTok{    }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{title =} \StringTok{"Simulated scatter1 example: Y vs. X"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics{431-notes_files/figure-latex/unnamed-chunk-131-1} \end{center}
...
\KeywordTok{boxCox}\NormalTok{(scatter1}\OperatorTok{$}\NormalTok{y }\OperatorTok{~}\StringTok{ }\NormalTok{scatter1}\OperatorTok{$}\NormalTok{x) }
\end{Highlighting}
\end{Shaded}

\includegraphics{431-notes_files/figure-latex/unnamed-chunk-132-1.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{powerTransform}\NormalTok{(scatter1}\OperatorTok{$}\NormalTok{y }\OperatorTok{~}\StringTok{ }\NormalTok{scatter1}\OperatorTok{$}\NormalTok{x)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{431-notes_files/figure-latex/unnamed-chunk-133-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{cor}\NormalTok{(scatter1}\OperatorTok{$}\NormalTok{y, scatter1}\OperatorTok{$}\NormalTok{x)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{cor}\NormalTok{(}\KeywordTok{sqrt}\NormalTok{(scatter1}\OperatorTok{$}\NormalTok{y), scatter1}\OperatorTok{$}\NormalTok{x)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{testTransform}\NormalTok{(}\KeywordTok{powerTransform}\NormalTok{(scatter1}\OperatorTok{$}\NormalTok{y }\OperatorTok{~}\StringTok{ }\NormalTok{scatter1}\OperatorTok{$}\NormalTok{x), }\DecValTok{0}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{testTransform}\NormalTok{(}\KeywordTok{powerTransform}\NormalTok{(scatter1}\OperatorTok{$}\NormalTok{y }\OperatorTok{~}\StringTok{ }\NormalTok{scatter1}\OperatorTok{$}\NormalTok{x), }\FloatTok{0.5}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{testTransform}\NormalTok{(}\KeywordTok{powerTransform}\NormalTok{(scatter1}\OperatorTok{$}\NormalTok{y }\OperatorTok{~}\StringTok{ }\NormalTok{scatter1}\OperatorTok{$}\NormalTok{x), }\DecValTok{1}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{model.orig <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(scatter1}\OperatorTok{$}\NormalTok{y }\OperatorTok{~}\StringTok{ }\NormalTok{scatter1}\OperatorTok{$}\NormalTok{x)}
\NormalTok{model.sqrt <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\KeywordTok{sqrt}\NormalTok{(scatter1}\OperatorTok{$}\NormalTok{y) }\OperatorTok{~}\StringTok{ }\NormalTok{scatter1}\OperatorTok{$}\NormalTok{x)}

\NormalTok{p1 <-}\StringTok{ }\KeywordTok{augment}\NormalTok{(model.orig) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{ggplot}\NormalTok{(., }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ scatter1}\OperatorTok{$}\NormalTok{x, }\DataTypeTok{y =}\NormalTok{ .resid)) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{geom_point}\NormalTok{() }\OperatorTok{+}
\StringTok{    }\KeywordTok{geom_smooth}\NormalTok{(}\DataTypeTok{method =} \StringTok{"loess"}\NormalTok{, }\DataTypeTok{formula =}\NormalTok{ y }\OperatorTok{~}\StringTok{ }\NormalTok{x, }\DataTypeTok{se =} \OtherTok{FALSE}\NormalTok{) }\OperatorTok{+}
\StringTok{    }\KeywordTok{geom_smooth}\NormalTok{(}\DataTypeTok{method =} \StringTok{"lm"}\NormalTok{, }\DataTypeTok{formula =}\NormalTok{ y }\OperatorTok{~}\StringTok{ }\NormalTok{x, }\DataTypeTok{se =} \OtherTok{FALSE}\NormalTok{, }\DataTypeTok{col =} \StringTok{"red"}\NormalTok{) }\OperatorTok{+}
\StringTok{    }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{title =} \StringTok{"Y vs X Residual Plot"}\NormalTok{)}

\NormalTok{p2 <-}\StringTok{ }\KeywordTok{augment}\NormalTok{(model.sqrt) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{ggplot}\NormalTok{(., }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ scatter1}\OperatorTok{$}\NormalTok{x, }\DataTypeTok{y =}\NormalTok{ .resid)) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{geom_point}\NormalTok{() }\OperatorTok{+}
\StringTok{    }\KeywordTok{geom_smooth}\NormalTok{(}\DataTypeTok{method =} \StringTok{"loess"}\NormalTok{, }\DataTypeTok{formula =}\NormalTok{ y }\OperatorTok{~}\StringTok{ }\NormalTok{x, }\DataTypeTok{se =} \OtherTok{FALSE}\NormalTok{) }\OperatorTok{+}
\StringTok{    }\KeywordTok{geom_smooth}\NormalTok{(}\DataTypeTok{method =} \StringTok{"lm"}\NormalTok{, }\DataTypeTok{formula =}\NormalTok{ y }\OperatorTok{~}\StringTok{ }\NormalTok{x, }\DataTypeTok{se =} \OtherTok{FALSE}\NormalTok{, }\DataTypeTok{col =} \StringTok{"red"}\NormalTok{) }\OperatorTok{+}
\StringTok{    }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{title =} \StringTok{"Square Root Model Residuals"}\NormalTok{)}

\NormalTok{p1 }\OperatorTok{+}\StringTok{ }\NormalTok{p2}
\end{Highlighting}
\end{Shaded}

\includegraphics{431-notes_files/figure-latex/unnamed-chunk-136-1.pdf}
...
\includegraphics{431-notes_files/figure-latex/scatterplot_matrix_hydrate_fig-1.pdf}
...
\hypertarget{are-the-recovery-scores-well-described-by-a-normal-model}{%
\section{Are the recovery scores well described by a Normal model?}\label{are-the-recovery-scores-well-described-by-a-normal-model}}

Next, we'll do a more thorough graphical summary of our outcome, recovery score.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{p1 <-}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(hydrate, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{sample =}\NormalTok{ recov.score)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_qq}\NormalTok{(}\DataTypeTok{col =} \StringTok{'#440154'}\NormalTok{) }\OperatorTok{+}\StringTok{ }\KeywordTok{geom_qq_line}\NormalTok{(}\DataTypeTok{col =} \StringTok{"red"}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{theme}\NormalTok{(}\DataTypeTok{aspect.ratio =} \DecValTok{1}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{title =} \StringTok{"Normal Q-Q plot: hydrate"}\NormalTok{)}

\NormalTok{p2 <-}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(hydrate, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ recov.score)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_histogram}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{y =} \KeywordTok{stat}\NormalTok{(density)), }
                 \DataTypeTok{bins =} \DecValTok{10}\NormalTok{, }\DataTypeTok{fill =} \StringTok{'#440154'}\NormalTok{, }\DataTypeTok{col =} \StringTok{'#FDE725'}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{stat_function}\NormalTok{(}\DataTypeTok{fun =}\NormalTok{ dnorm, }
                \DataTypeTok{args =} \KeywordTok{list}\NormalTok{(}\DataTypeTok{mean =} \KeywordTok{mean}\NormalTok{(hydrate}\OperatorTok{$}\NormalTok{recov.score), }
                            \DataTypeTok{sd =} \KeywordTok{sd}\NormalTok{(hydrate}\OperatorTok{$}\NormalTok{recov.score)),}
                \DataTypeTok{col =} \StringTok{"red"}\NormalTok{, }\DataTypeTok{lwd =} \FloatTok{1.5}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{title =} \StringTok{"Density Function: hydrate"}\NormalTok{)}

\NormalTok{p3 <-}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(hydrate, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ recov.score, }\DataTypeTok{y =} \StringTok{""}\NormalTok{)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_boxplot}\NormalTok{(}\DataTypeTok{fill =} \StringTok{'#440154'}\NormalTok{, }\DataTypeTok{outlier.color =} \StringTok{'#440154'}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{title =} \StringTok{"Boxplot: hydrate"}\NormalTok{, }\DataTypeTok{y =} \StringTok{""}\NormalTok{)}
...
\includegraphics{431-notes_files/figure-latex/unnamed-chunk-137-1.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mosaic}\OperatorTok{::}\KeywordTok{favstats}\NormalTok{(}\OperatorTok{~}\StringTok{ }\NormalTok{recov.score, }\DataTypeTok{data =}\NormalTok{ hydrate) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{kable}\NormalTok{(}\DataTypeTok{digits =} \DecValTok{1}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{431-notes_files/figure-latex/scatterplot_model_hydrate_1-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{m1 <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(recov.score }\OperatorTok{~}\StringTok{ }\NormalTok{dose, }\DataTypeTok{data =}\NormalTok{ hydrate)}

\KeywordTok{tidy}\NormalTok{(m1) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{kable}\NormalTok{(}\DataTypeTok{digits =} \DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{tidy}\NormalTok{(m1, }\DataTypeTok{conf.int =} \OtherTok{TRUE}\NormalTok{, }\DataTypeTok{conf.level =} \FloatTok{0.90}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{kable}\NormalTok{(}\DataTypeTok{digits =} \DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{td <-}\StringTok{ }\KeywordTok{tidy}\NormalTok{(m1, }\DataTypeTok{conf.int =} \OtherTok{TRUE}\NormalTok{, }\DataTypeTok{conf.level =} \FloatTok{0.90}\NormalTok{)}
\KeywordTok{ggplot}\NormalTok{(td, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ estimate, }\DataTypeTok{y =}\NormalTok{ term, }\DataTypeTok{col =}\NormalTok{ term)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_point}\NormalTok{() }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_crossbarh}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{xmin =}\NormalTok{ conf.low, }\DataTypeTok{xmax =}\NormalTok{ conf.high)) }\OperatorTok{+}
...
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{title =} \StringTok{"Estimates with 90% confidence intervals from m1 in hydrate"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{431-notes_files/figure-latex/unnamed-chunk-140-1.pdf}

Another option would be to use \texttt{geom\_errorbarh} in this setting, perhaps with a different color scheme\ldots{}
...
\StringTok{  }\KeywordTok{geom_vline}\NormalTok{(}\DataTypeTok{xintercept =} \DecValTok{0}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{scale_color_viridis_d}\NormalTok{(}\DataTypeTok{end =} \FloatTok{0.5}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{guides}\NormalTok{(}\DataTypeTok{col =} \OtherTok{FALSE}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{title =} \StringTok{"Estimates with 90% confidence intervals from m1 in hydrate"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{431-notes_files/figure-latex/unnamed-chunk-141-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{cor}\NormalTok{(hydrate}\OperatorTok{$}\NormalTok{recov.score, hydrate}\OperatorTok{$}\NormalTok{dose)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{tidy}\NormalTok{(m1, }\DataTypeTok{conf.int =} \OtherTok{TRUE}\NormalTok{, }\DataTypeTok{conf.level =} \FloatTok{0.95}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{kable}\NormalTok{(}\DataTypeTok{digits =} \DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{glance}\NormalTok{(m1) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{select}\NormalTok{(r.squared}\OperatorTok{:}\NormalTok{df, df.residual, nobs) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{kable}\NormalTok{(}\DataTypeTok{digits =} \KeywordTok{c}\NormalTok{(}\DecValTok{3}\NormalTok{, }\DecValTok{3}\NormalTok{, }\DecValTok{1}\NormalTok{, }\DecValTok{2}\NormalTok{, }\DecValTok{3}\NormalTok{, }\DecValTok{0}\NormalTok{, }\DecValTok{0}\NormalTok{, }\DecValTok{0}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{glance}\NormalTok{(m1) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{select}\NormalTok{(logLik}\OperatorTok{:}\NormalTok{deviance) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{kable}\NormalTok{(}\DataTypeTok{digits =} \DecValTok{1}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{augment}\NormalTok{(m1) }\OperatorTok{%>%}
...
\StringTok{    }\KeywordTok{geom_point}\NormalTok{() }\OperatorTok{+}
\StringTok{    }\KeywordTok{geom_smooth}\NormalTok{(}\DataTypeTok{method =} \StringTok{"loess"}\NormalTok{, }\DataTypeTok{formula =}\NormalTok{ y }\OperatorTok{~}\StringTok{ }\NormalTok{x, }\DataTypeTok{se =}\NormalTok{ F) }\OperatorTok{+}
\StringTok{    }\KeywordTok{geom_smooth}\NormalTok{(}\DataTypeTok{method =} \StringTok{"lm"}\NormalTok{, }\DataTypeTok{formula =}\NormalTok{ y }\OperatorTok{~}\StringTok{ }\NormalTok{x, }\DataTypeTok{se =}\NormalTok{ F, }\DataTypeTok{col =} \StringTok{"red"}\NormalTok{) }\OperatorTok{+}
\StringTok{    }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{title =} \StringTok{"Residuals vs. Fitted values for Model m1"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{431-notes_files/figure-latex/unnamed-chunk-146-1.pdf}
...
\includegraphics{431-notes_files/figure-latex/unnamed-chunk-147-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{p1 <-}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(serzinc, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{sample =}\NormalTok{ zinc)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_qq}\NormalTok{(}\DataTypeTok{col =} \StringTok{"dodgerblue"}\NormalTok{) }\OperatorTok{+}\StringTok{ }\KeywordTok{geom_qq_line}\NormalTok{(}\DataTypeTok{col =} \StringTok{"navy"}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{theme}\NormalTok{(}\DataTypeTok{aspect.ratio =} \DecValTok{1}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{title =} \StringTok{"Normal Q-Q plot"}\NormalTok{)}

\NormalTok{p2 <-}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(serzinc, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ zinc)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_histogram}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{y =} \KeywordTok{stat}\NormalTok{(density)), }
                 \DataTypeTok{bins =} \DecValTok{10}\NormalTok{, }\DataTypeTok{fill =} \StringTok{"dodgerblue"}\NormalTok{, }\DataTypeTok{col =} \StringTok{"white"}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{stat_function}\NormalTok{(}\DataTypeTok{fun =}\NormalTok{ dnorm, }
                \DataTypeTok{args =} \KeywordTok{list}\NormalTok{(}\DataTypeTok{mean =} \KeywordTok{mean}\NormalTok{(serzinc}\OperatorTok{$}\NormalTok{zinc), }
                            \DataTypeTok{sd =} \KeywordTok{sd}\NormalTok{(serzinc}\OperatorTok{$}\NormalTok{zinc)),}
                \DataTypeTok{col =} \StringTok{"navy"}\NormalTok{, }\DataTypeTok{lwd =} \FloatTok{1.5}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{title =} \StringTok{"Histogram and Normal Density"}\NormalTok{)}

\NormalTok{p3 <-}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(serzinc, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ zinc, }\DataTypeTok{y =} \StringTok{""}\NormalTok{)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_boxplot}\NormalTok{(}\DataTypeTok{fill =} \StringTok{"dodgerblue"}\NormalTok{, }\DataTypeTok{outlier.color =} \StringTok{"dodgerblue"}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{title =} \StringTok{"Boxplot"}\NormalTok{, }\DataTypeTok{y =} \StringTok{""}\NormalTok{)}

\NormalTok{p1 }\OperatorTok{+}\StringTok{ }\NormalTok{(p2 }\OperatorTok{/}\StringTok{ }\NormalTok{p3 }\OperatorTok{+}\StringTok{ }\KeywordTok{plot_layout}\NormalTok{(}\DataTypeTok{heights =} \KeywordTok{c}\NormalTok{(}\DecValTok{4}\NormalTok{,}\DecValTok{1}\NormalTok{))) }\OperatorTok{+}
\StringTok{  }\KeywordTok{plot_annotation}\NormalTok{(}\DataTypeTok{title =} \StringTok{"Serum Zinc (micrograms per deciliter) for 462 Teenage Males"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{431-notes_files/figure-latex/unnamed-chunk-150-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mosaic}\OperatorTok{::}\KeywordTok{favstats}\NormalTok{(}\OperatorTok{~}\StringTok{ }\NormalTok{zinc, }\DataTypeTok{data =}\NormalTok{ serzinc) }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\KeywordTok{kable}\NormalTok{(}\DataTypeTok{digits =} \DecValTok{3}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{serzinc }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{summarize}\NormalTok{(}\KeywordTok{mean}\NormalTok{(zinc), }\KeywordTok{median}\NormalTok{(zinc), }\KeywordTok{sd}\NormalTok{(zinc),}
              \DataTypeTok{skew1 =}\NormalTok{ (}\KeywordTok{mean}\NormalTok{(zinc) }\OperatorTok{-}\StringTok{ }\KeywordTok{median}\NormalTok{(zinc))}\OperatorTok{/}\KeywordTok{sd}\NormalTok{(zinc)) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{kable}\NormalTok{(}\DataTypeTok{digits =} \DecValTok{3}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{serzinc }\OperatorTok{%$%}\StringTok{ }\NormalTok{psych}\OperatorTok{::}\KeywordTok{describe}\NormalTok{(zinc)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{431-notes_files/figure-latex/unnamed-chunk-153-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{tidy}\NormalTok{(model_zinc, }\DataTypeTok{conf.int =} \OtherTok{TRUE}\NormalTok{, }\DataTypeTok{conf =} \FloatTok{0.90}\NormalTok{) }\OperatorTok{%>%}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{tt <-}\StringTok{ }\KeywordTok{t.test}\NormalTok{(serzinc}\OperatorTok{$}\NormalTok{zinc, }
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# requires library(broom)}
\KeywordTok{tidy}\NormalTok{(tt, }\DataTypeTok{conf.int =} \OtherTok{TRUE}\NormalTok{, }\DataTypeTok{conf =} \FloatTok{0.90}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{knitr}\OperatorTok{::}\KeywordTok{kable}\NormalTok{(}\DataTypeTok{digits =} \DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{tt <-}\StringTok{ }\KeywordTok{t.test}\NormalTok{(serzinc}\OperatorTok{$}\NormalTok{zinc, }\DataTypeTok{conf.level =} \FloatTok{0.95}\NormalTok{, }\DataTypeTok{alternative =} \StringTok{"two.sided"}\NormalTok{)}
\KeywordTok{tidy}\NormalTok{(tt)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{t.test}\NormalTok{(serzinc}\OperatorTok{$}\NormalTok{zinc, }\DataTypeTok{conf.level =} \FloatTok{0.90}\NormalTok{, }\DataTypeTok{alternative =} \StringTok{"greater"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{t.test}\NormalTok{(serzinc}\OperatorTok{$}\NormalTok{zinc, }\DataTypeTok{conf.level =} \FloatTok{0.90}\NormalTok{, }\DataTypeTok{alternative =} \StringTok{"less"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\KeywordTok{set.seed}\NormalTok{(}\DecValTok{431}\NormalTok{)}
\NormalTok{serzinc }\OperatorTok{%$%}\StringTok{ }\NormalTok{Hmisc}\OperatorTok{::}\KeywordTok{smean.cl.boot}\NormalTok{(zinc, }\DataTypeTok{B =} \DecValTok{1000}\NormalTok{, }\DataTypeTok{conf.int =} \FloatTok{0.90}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{serzinc }\OperatorTok{%$%}\StringTok{ }\NormalTok{Hmisc}\OperatorTok{::}\KeywordTok{smean.cl.normal}\NormalTok{(zinc, }\DataTypeTok{conf.int =} \FloatTok{0.90}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{set.seed}\NormalTok{(}\DecValTok{431654}\NormalTok{)}
\NormalTok{serzinc }\OperatorTok{%$%}\StringTok{ }\NormalTok{Hmisc}\OperatorTok{::}\KeywordTok{smean.cl.boot}\NormalTok{(zinc, }\DataTypeTok{B =} \DecValTok{1000}\NormalTok{, }\DataTypeTok{conf.int =} \FloatTok{0.95}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{set.seed}\NormalTok{(}\DecValTok{431321}\NormalTok{)}
\NormalTok{serzinc }\OperatorTok{%$%}\StringTok{ }\NormalTok{Hmisc}\OperatorTok{::}\KeywordTok{smean.cl.boot}\NormalTok{(zinc, }\DataTypeTok{B =} \DecValTok{1000}\NormalTok{, }\DataTypeTok{conf.int =} \FloatTok{0.99}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{set.seed}\NormalTok{(}\DecValTok{43101}\NormalTok{)}
\NormalTok{serzinc }\OperatorTok{%$%}\StringTok{ }\NormalTok{Hmisc}\OperatorTok{::}\KeywordTok{smean.cl.boot}\NormalTok{(zinc, }\DataTypeTok{B =} \DecValTok{1000}\NormalTok{, }\DataTypeTok{conf.int =} \FloatTok{0.90}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{set.seed}\NormalTok{(}\DecValTok{431787}\NormalTok{)}
\NormalTok{boot}\OperatorTok{::}\KeywordTok{boot.ci}\NormalTok{(boot}\OperatorTok{::}\KeywordTok{boot}\NormalTok{ (serzinc}\OperatorTok{$}\NormalTok{zinc, f.median, }\DecValTok{1000}\NormalTok{), }\DataTypeTok{conf=}\FloatTok{0.90}\NormalTok{, }\DataTypeTok{type=}\StringTok{"basic"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{IQR}\NormalTok{(serzinc}\OperatorTok{$}\NormalTok{zinc)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{f.IQR <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(y, id) }
\NormalTok{\{    }\KeywordTok{IQR}\NormalTok{ (y[id]) \}}

\KeywordTok{set.seed}\NormalTok{(}\DecValTok{431207}\NormalTok{)}
\NormalTok{boot}\OperatorTok{::}\KeywordTok{boot.ci}\NormalTok{(boot}\OperatorTok{::}\KeywordTok{boot}\NormalTok{ (serzinc}\OperatorTok{$}\NormalTok{zinc, f.IQR, }\DecValTok{1000}\NormalTok{), }
        \DataTypeTok{conf=}\FloatTok{0.95}\NormalTok{, }\DataTypeTok{type=}\StringTok{"basic"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{serzinc }\OperatorTok{%$%}\StringTok{ }\KeywordTok{wilcox.test}\NormalTok{(zinc, }\DataTypeTok{conf.int =} \OtherTok{TRUE}\NormalTok{, }\DataTypeTok{conf.level =} \FloatTok{0.95}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{wt <-}\StringTok{ }\NormalTok{serzinc }\OperatorTok{%$%}\StringTok{ }\KeywordTok{wilcox.test}\NormalTok{(zinc, }\DataTypeTok{conf.int =} \OtherTok{TRUE}\NormalTok{, }\DataTypeTok{conf.level =} \FloatTok{0.95}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{sepsis <-}\StringTok{ }\NormalTok{sepsis }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{treat =} \KeywordTok{factor}\NormalTok{(treat),}
           \DataTypeTok{race =} \KeywordTok{factor}\NormalTok{(race))}

\KeywordTok{summary}\NormalTok{(sepsis)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{431-notes_files/figure-latex/unnamed-chunk-175-1.pdf}
...
\includegraphics{431-notes_files/figure-latex/sepsis_temp_drop_by_treat_histograms-1.pdf}
...
\includegraphics{431-notes_files/figure-latex/unnamed-chunk-176-1.pdf}
...
\includegraphics{431-notes_files/figure-latex/unnamed-chunk-177-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{model_sep <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(temp_drop }\OperatorTok{~}\StringTok{ }\NormalTok{treat }\OperatorTok{==}\StringTok{ "Ibuprofen"}\NormalTok{, }\DataTypeTok{data =}\NormalTok{ sepsis)}

\KeywordTok{tidy}\NormalTok{(model_sep, }\DataTypeTok{conf.int =} \OtherTok{TRUE}\NormalTok{, }\DataTypeTok{conf.level =} \FloatTok{0.90}\NormalTok{) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{kable}\NormalTok{(}\DataTypeTok{digits =} \DecValTok{3}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{model_sep2 <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(temp_drop }\OperatorTok{~}\StringTok{ }\NormalTok{treat, }\DataTypeTok{data =}\NormalTok{ sepsis)}

\KeywordTok{tidy}\NormalTok{(model_sep2, }\DataTypeTok{conf.int =} \OtherTok{TRUE}\NormalTok{, }\DataTypeTok{conf.level =} \FloatTok{0.90}\NormalTok{) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{kable}\NormalTok{(}\DataTypeTok{digits =} \DecValTok{3}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{sepsis }\OperatorTok{%$%}\StringTok{ }\KeywordTok{t.test}\NormalTok{(temp_drop }\OperatorTok{~}\StringTok{ }\NormalTok{treat,}
                  \DataTypeTok{conf.level =} \FloatTok{0.90}\NormalTok{,}
                  \DataTypeTok{alt =} \StringTok{"two.sided"}\NormalTok{,}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{tt1 <-}\StringTok{ }\NormalTok{sepsis }\OperatorTok{%$%}\StringTok{ }\KeywordTok{t.test}\NormalTok{(temp_drop }\OperatorTok{~}\StringTok{ }\NormalTok{treat,}
                  \DataTypeTok{conf.level =} \FloatTok{0.90}\NormalTok{,}
                  \DataTypeTok{alt =} \StringTok{"two.sided"}\NormalTok{,}
                  \DataTypeTok{var.equal =} \OtherTok{TRUE}\NormalTok{)}
\KeywordTok{tidy}\NormalTok{(tt1)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{tidy}\NormalTok{(model1, }\DataTypeTok{conf.int =} \OtherTok{TRUE}\NormalTok{, }\DataTypeTok{conf.level =} \FloatTok{0.95}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{kable}\NormalTok{(}\DataTypeTok{digits =} \DecValTok{3}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{tt0 <-}\StringTok{ }\NormalTok{sepsis }\OperatorTok{%$%}\StringTok{ }\KeywordTok{t.test}\NormalTok{(temp_drop }\OperatorTok{~}\StringTok{ }\NormalTok{treat,}
                  \DataTypeTok{conf.level =} \FloatTok{0.90}\NormalTok{, }
                  \DataTypeTok{alt =} \StringTok{"two.sided"}\NormalTok{)}

\KeywordTok{tidy}\NormalTok{(tt0)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{wt <-}\StringTok{ }\NormalTok{sepsis }\OperatorTok{%$%}\StringTok{ }\KeywordTok{wilcox.test}\NormalTok{(temp_drop }\OperatorTok{~}\StringTok{ }\NormalTok{treat,}
                       \DataTypeTok{conf.int =} \OtherTok{TRUE}\NormalTok{, }\DataTypeTok{conf.level =} \FloatTok{0.90}\NormalTok{,}
                       \DataTypeTok{alt =} \StringTok{"two.sided"}\NormalTok{) }
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{set.seed}\NormalTok{(}\DecValTok{431212}\NormalTok{)}

\NormalTok{sepsis }\OperatorTok{%$%}\StringTok{ }\KeywordTok{bootdif}\NormalTok{(temp_drop, treat, }\DataTypeTok{conf.level =} \FloatTok{0.90}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{431-notes_files/figure-latex/unnamed-chunk-192-1.pdf}
...
\includegraphics{431-notes_files/figure-latex/unnamed-chunk-193-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{s_pooled_t_test <-}\StringTok{ }\NormalTok{sepsis }\OperatorTok{%$%}\StringTok{ }\KeywordTok{t.test}\NormalTok{(temp_drop }\OperatorTok{~}\StringTok{ }\NormalTok{treat, }
                           \DataTypeTok{conf.level =} \FloatTok{0.90}\NormalTok{,}
                           \DataTypeTok{alt =} \StringTok{"two.sided"}\NormalTok{, }
                           \DataTypeTok{var.equal =} \OtherTok{TRUE}\NormalTok{)}

\KeywordTok{tidy}\NormalTok{(s_pooled_t_test) }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\KeywordTok{select}\NormalTok{(conf.low, conf.high)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{s_welch_t_test <-}\StringTok{ }\NormalTok{sepsis }\OperatorTok{%$%}\StringTok{ }\KeywordTok{t.test}\NormalTok{(temp_drop }\OperatorTok{~}\StringTok{ }\NormalTok{treat, }
                           \DataTypeTok{conf.level =} \FloatTok{0.90}\NormalTok{,}
                           \DataTypeTok{alt =} \StringTok{"two.sided"}\NormalTok{, }
                           \DataTypeTok{var.equal =} \OtherTok{FALSE}\NormalTok{)}

\KeywordTok{tidy}\NormalTok{(s_welch_t_test) }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\KeywordTok{select}\NormalTok{(estimate, conf.low, conf.high)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{s_wilcoxon_test <-}\StringTok{ }\NormalTok{sepsis }\OperatorTok{%$%}\StringTok{ }\KeywordTok{wilcox.test}\NormalTok{(temp_drop }\OperatorTok{~}\StringTok{ }\NormalTok{treat,}
                       \DataTypeTok{conf.int =} \OtherTok{TRUE}\NormalTok{, }\DataTypeTok{conf.level =} \FloatTok{0.90}\NormalTok{,}
                       \DataTypeTok{alt =} \StringTok{"two.sided"}\NormalTok{) }

\KeywordTok{tidy}\NormalTok{(s_wilcoxon_test) }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\KeywordTok{select}\NormalTok{(estimate, conf.low, conf.high)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\KeywordTok{set.seed}\NormalTok{(}\DecValTok{431212}\NormalTok{)}
\NormalTok{s_bootstrap <-}\StringTok{ }\NormalTok{sepsis }\OperatorTok{%$%}\StringTok{ }\KeywordTok{bootdif}\NormalTok{(temp_drop, treat, }
                                  \DataTypeTok{conf.level =} \FloatTok{0.90}\NormalTok{)}

\NormalTok{s_bootstrap}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{sepsis <-}\StringTok{ }\NormalTok{sepsis }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{dropped =} \KeywordTok{ifelse}\NormalTok{(temp_drop }\OperatorTok{>}\StringTok{ }\DecValTok{0}\NormalTok{, }\StringTok{"Drop"}\NormalTok{, }\StringTok{"No Drop"}\NormalTok{))}

\NormalTok{sepsis }\OperatorTok{%>%}\StringTok{ }\KeywordTok{tabyl}\NormalTok{(treat, dropped)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{sepsis }\OperatorTok{%>%}\StringTok{ }\KeywordTok{tabyl}\NormalTok{(treat, dropped) }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\KeywordTok{adorn_totals}\NormalTok{() }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{adorn_percentages}\NormalTok{(}\DataTypeTok{denom =} \StringTok{"row"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{adorn_pct_formatting}\NormalTok{(}\DataTypeTok{digits =} \DecValTok{1}\NormalTok{) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{adorn_ns}\NormalTok{(}\DataTypeTok{position =} \StringTok{"front"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{sepsis }\OperatorTok{%$%}\StringTok{ }\KeywordTok{table}\NormalTok{(treat, dropped) }\OperatorTok{%>%}\StringTok{ }\NormalTok{Epi}\OperatorTok{::}\KeywordTok{twoby2}\NormalTok{(}\DataTypeTok{alpha =} \FloatTok{0.10}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{bloodlead_original <-}\StringTok{ }\NormalTok{bloodlead}

\NormalTok{bloodlead <-}\StringTok{ }\NormalTok{bloodlead_original }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{pair =} \KeywordTok{factor}\NormalTok{(pair),}
           \DataTypeTok{lead_diff =}\NormalTok{ exposed }\OperatorTok{-}\StringTok{ }\NormalTok{control)}
...
\hypertarget{the-paired-differences}{%
\subsection{The Paired Differences}\label{the-paired-differences}}

To begin, we focus on \texttt{lead\_diff} for our exploratory work, which is the \texttt{exposed} - \texttt{control} difference in lead content within each of the 33 pairs. So, we'll have 33 observations, as compared to the 462 in the serum zinc data, but most of the same tools are still helpful.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{p1 <-}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(bloodlead, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{sample =}\NormalTok{ lead_diff)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_qq}\NormalTok{(}\DataTypeTok{col =} \StringTok{"darkslategray"}\NormalTok{) }\OperatorTok{+}\StringTok{ }\KeywordTok{geom_qq_line}\NormalTok{(}\DataTypeTok{col =} \StringTok{"navy"}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{theme}\NormalTok{(}\DataTypeTok{aspect.ratio =} \DecValTok{1}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{title =} \StringTok{"Normal Q-Q plot"}\NormalTok{)}

\NormalTok{p2 <-}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(bloodlead, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ lead_diff)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_histogram}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{y =} \KeywordTok{stat}\NormalTok{(density)), }
                 \DataTypeTok{binwidth =} \DecValTok{5}\NormalTok{, }\DataTypeTok{fill =} \StringTok{"darkslategray"}\NormalTok{, }\DataTypeTok{col =} \StringTok{"white"}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{stat_function}\NormalTok{(}\DataTypeTok{fun =}\NormalTok{ dnorm, }
                \DataTypeTok{args =} \KeywordTok{list}\NormalTok{(}\DataTypeTok{mean =} \KeywordTok{mean}\NormalTok{(bloodlead}\OperatorTok{$}\NormalTok{lead_diff), }
                            \DataTypeTok{sd =} \KeywordTok{sd}\NormalTok{(bloodlead}\OperatorTok{$}\NormalTok{lead_diff)),}
                \DataTypeTok{col =} \StringTok{"navy"}\NormalTok{, }\DataTypeTok{lwd =} \FloatTok{1.5}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{title =} \StringTok{"Histogram with Normal Density"}\NormalTok{)}
...
\includegraphics{431-notes_files/figure-latex/unnamed-chunk-204-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{bloodlead }\OperatorTok{%>%}\StringTok{ }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{skew1 =} 
\NormalTok{                            (}\KeywordTok{mean}\NormalTok{(lead_diff) }\OperatorTok{-}\StringTok{ }\KeywordTok{median}\NormalTok{(lead_diff)) }\OperatorTok{/}\StringTok{ }
\StringTok{                            }\KeywordTok{sd}\NormalTok{(lead_diff))}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{impact-of-matching---scatterplot-and-correlation}{%
\subsection{Impact of Matching - Scatterplot and Correlation}\label{impact-of-matching---scatterplot-and-correlation}}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{ggplot}\NormalTok{(bloodlead, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ control, }\DataTypeTok{y =}\NormalTok{ exposed)) }\OperatorTok{+}
\StringTok{    }\KeywordTok{geom_point}\NormalTok{(}\DataTypeTok{size =} \DecValTok{2}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{geom_smooth}\NormalTok{(}\DataTypeTok{method =} \StringTok{"lm"}\NormalTok{, }\DataTypeTok{formula =}\NormalTok{ y }\OperatorTok{~}\StringTok{ }\NormalTok{x, }\DataTypeTok{se =} \OtherTok{FALSE}\NormalTok{) }\OperatorTok{+}
\StringTok{    }\KeywordTok{geom_text}\NormalTok{(}\DataTypeTok{x =} \DecValTok{20}\NormalTok{, }\DataTypeTok{y =} \DecValTok{65}\NormalTok{, }\DataTypeTok{col =} \StringTok{"blue"}\NormalTok{, }
             \DataTypeTok{label =} 
                 \KeywordTok{paste}\NormalTok{(}\StringTok{"Pearson r = "}\NormalTok{,}
                       \KeywordTok{round}\NormalTok{(bloodlead }\OperatorTok{%$%}\StringTok{ }
\StringTok{                                 }\KeywordTok{cor}\NormalTok{(control, exposed),}\DecValTok{2}\NormalTok{))) }\OperatorTok{+}
\StringTok{    }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{title =} \StringTok{"Paired Samples in Blood Lead study"}\NormalTok{,}
         \DataTypeTok{x =} \StringTok{"Blood Lead Content (mg/dl) in Control Child"}\NormalTok{,}
         \DataTypeTok{y =} \StringTok{"Blood Lead Content (mg/dl) in Exposed Child"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{431-notes_files/figure-latex/unnamed-chunk-206-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{bloodlead_longer <-}\StringTok{ }\NormalTok{bloodlead_original }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{pivot_longer}\NormalTok{(}
        \DataTypeTok{cols =} \OperatorTok{-}\KeywordTok{c}\NormalTok{(pair),}
        \DataTypeTok{names_to =} \StringTok{"status"}\NormalTok{,}
        \DataTypeTok{values_to =} \StringTok{"lead_level"}\NormalTok{)}

\NormalTok{bloodlead_longer}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{431-notes_files/figure-latex/unnamed-chunk-209-1.pdf}
...
\includegraphics{431-notes_files/figure-latex/unnamed-chunk-210-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mosaic}\OperatorTok{::}\KeywordTok{favstats}\NormalTok{(lead_level }\OperatorTok{~}\StringTok{ }\NormalTok{status, }\DataTypeTok{data =}\NormalTok{ bloodlead_longer) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{kable}\NormalTok{(}\DataTypeTok{digits =} \DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{tidy}\NormalTok{(model_lead, }\DataTypeTok{conf.int =} \OtherTok{TRUE}\NormalTok{, }\DataTypeTok{conf.level =} \FloatTok{0.90}\NormalTok{) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{kable}\NormalTok{(}\DataTypeTok{digits =} \DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{tidy}\NormalTok{(model2_lead, }\DataTypeTok{conf.int =} \OtherTok{TRUE}\NormalTok{, }\DataTypeTok{conf.level =} \FloatTok{0.90}\NormalTok{) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{filter}\NormalTok{(term }\OperatorTok{==}\StringTok{ "statusexposed"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\NormalTok{knitr}\OperatorTok{::}\KeywordTok{kable}\NormalTok{(}\DataTypeTok{digits =} \DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{tt1 <-}\StringTok{ }\NormalTok{bloodlead }\OperatorTok{%$%}\StringTok{ }\KeywordTok{t.test}\NormalTok{(lead_diff, }\DataTypeTok{conf.level =} \FloatTok{0.90}\NormalTok{, }
                            \DataTypeTok{alt =} \StringTok{"two.sided"}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{tidy}\NormalTok{(tt1) }\OperatorTok{%>%}\StringTok{ }\NormalTok{knitr}\OperatorTok{::}\KeywordTok{kable}\NormalTok{(}\DataTypeTok{digits =} \DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{tt2 <-}\StringTok{ }\NormalTok{bloodlead }\OperatorTok{%$%}\StringTok{ }\KeywordTok{t.test}\NormalTok{(exposed }\OperatorTok{-}\StringTok{ }\NormalTok{control, }
       \DataTypeTok{conf.level =} \FloatTok{0.95}\NormalTok{, }\DataTypeTok{alt =} \StringTok{"two.sided"}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{tidy}\NormalTok{(tt2) }\OperatorTok{%>%}\StringTok{ }\NormalTok{knitr}\OperatorTok{::}\KeywordTok{kable}\NormalTok{(}\DataTypeTok{digits =} \DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{tt3 <-}\StringTok{ }\NormalTok{bloodlead }\OperatorTok{%$%}\StringTok{ }\KeywordTok{t.test}\NormalTok{(exposed, control, }\DataTypeTok{conf.level =} \FloatTok{0.99}\NormalTok{,}
       \DataTypeTok{paired =} \OtherTok{TRUE}\NormalTok{, }\DataTypeTok{alt =} \StringTok{"greater"}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{tidy}\NormalTok{(tt3) }\OperatorTok{%>%}\StringTok{ }\NormalTok{knitr}\OperatorTok{::}\KeywordTok{kable}\NormalTok{(}\DataTypeTok{digits =} \DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{tidy}\NormalTok{(model2_lead, }\DataTypeTok{conf.int =} \OtherTok{TRUE}\NormalTok{, }\DataTypeTok{conf.level =} \FloatTok{0.95}\NormalTok{) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{filter}\NormalTok{(term }\OperatorTok{==}\StringTok{ "statusexposed"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{set.seed}\NormalTok{(}\DecValTok{431555}\NormalTok{)}
\NormalTok{bloodlead }\OperatorTok{%$%}\StringTok{ }\NormalTok{Hmisc}\OperatorTok{::}\KeywordTok{smean.cl.boot}\NormalTok{(lead_diff, }\DataTypeTok{B =} \DecValTok{1000}\NormalTok{,}
                                   \DataTypeTok{conf.int =} \FloatTok{0.95}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{wt <-}\StringTok{ }\NormalTok{bloodlead }\OperatorTok{%$%}\StringTok{ }\KeywordTok{wilcox.test}\NormalTok{(lead_diff, }\DataTypeTok{conf.int =} \OtherTok{TRUE}\NormalTok{,}
                                \DataTypeTok{conf.level =} \FloatTok{0.90}\NormalTok{, }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{bloodlead}\OperatorTok{$}\NormalTok{lead_diff}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{431-notes_files/figure-latex/battery1-fig-1.pdf}
...
\includegraphics{431-notes_files/figure-latex/histogram-battery-fig-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{breakfast }\OperatorTok{%$%}\StringTok{ }\KeywordTok{cor}\NormalTok{(cornflakes, oatbran)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{431-notes_files/figure-latex/unnamed-chunk-227-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{t.test}\NormalTok{(breakfast}\OperatorTok{$}\NormalTok{cornflakes }\OperatorTok{-}\StringTok{ }\NormalTok{breakfast}\OperatorTok{$}\NormalTok{oatbran)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{nyfs2a <-}\StringTok{ }\NormalTok{nyfs2 }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{select}\NormalTok{(subject.id, income.cat3, GMQ) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{arrange}\NormalTok{(subject.id)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{nyfs2a }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{group_by}\NormalTok{(income.cat3) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{summarise}\NormalTok{(}\DataTypeTok{n =} \KeywordTok{n}\NormalTok{(), }\KeywordTok{mean}\NormalTok{(GMQ), }\KeywordTok{median}\NormalTok{(GMQ))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{nyfs2a}\OperatorTok{$}\NormalTok{income.cat3 <-}\StringTok{ }
\StringTok{    }\NormalTok{forcats}\OperatorTok{::}\KeywordTok{fct_relevel}\NormalTok{(nyfs2a}\OperatorTok{$}\NormalTok{income.cat3,}
                         \StringTok{"Low (below 25K)"}\NormalTok{,}
                         \StringTok{"Middle (25 - 64K)"}\NormalTok{,}
                         \StringTok{"High (65K or more)"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{431-notes_files/figure-latex/boxplot_nyfs2a-1.pdf}
...
\includegraphics{431-notes_files/figure-latex/histograms_nyfs2a-1.pdf}
...
\includegraphics{431-notes_files/figure-latex/nyfs2a_ridgelineplot-1.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{by}\NormalTok{(nyfs2a}\OperatorTok{$}\NormalTok{GMQ, nyfs2a}\OperatorTok{$}\NormalTok{income.cat3, mosaic}\OperatorTok{::}\NormalTok{favstats)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{nyfs2a }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{group_by}\NormalTok{(income.cat3) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{summarise}\NormalTok{(}\DataTypeTok{n =} \KeywordTok{n}\NormalTok{(), }\KeywordTok{mean}\NormalTok{(GMQ))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{pairwise.t.test}\NormalTok{(nyfs2a}\OperatorTok{$}\NormalTok{GMQ, nyfs2a}\OperatorTok{$}\NormalTok{income.cat3, }\DataTypeTok{p.adjust=}\StringTok{"bonferroni"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{431-notes_files/figure-latex/hsd_plot_nyfs2a-1.pdf}
...
\includegraphics{431-notes_files/figure-latex/unnamed-chunk-234-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{nyfs2}\OperatorTok{$}\NormalTok{income.cat3 <-}\StringTok{ }
\StringTok{    }\NormalTok{forcats}\OperatorTok{::}\KeywordTok{fct_relevel}\NormalTok{(nyfs2}\OperatorTok{$}\NormalTok{income.cat3,}
                         \StringTok{"Low (below 25K)"}\NormalTok{,}
                         \StringTok{"Middle (25 - 64K)"}\NormalTok{,}
                         \StringTok{"High (65K or more)"}\NormalTok{)}

\KeywordTok{ggplot}\NormalTok{(nyfs2, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ bmi, }\DataTypeTok{y =}\NormalTok{ income.cat3, }\DataTypeTok{fill =}\NormalTok{ income.cat3)) }\OperatorTok{+}
\StringTok{    }\NormalTok{ggridges}\OperatorTok{::}\KeywordTok{geom_density_ridges}\NormalTok{(}\DataTypeTok{scale =} \FloatTok{0.9}\NormalTok{) }\OperatorTok{+}
\StringTok{    }\KeywordTok{guides}\NormalTok{(}\DataTypeTok{fill =} \OtherTok{FALSE}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{title =} \StringTok{"Body-Mass Index by Income Group"}\NormalTok{,}
         \DataTypeTok{x =} \StringTok{"Body-Mass Index"}\NormalTok{, }\DataTypeTok{y =} \StringTok{""}\NormalTok{) }\OperatorTok{+}
\StringTok{    }\NormalTok{ggridges}\OperatorTok{::}\KeywordTok{theme_ridges}\NormalTok{()}
\end{Highlighting}
\end{Shaded}

\includegraphics{431-notes_files/figure-latex/unnamed-chunk-235-1.pdf}
...
\includegraphics{431-notes_files/figure-latex/unnamed-chunk-236-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{nyfs2}\OperatorTok{$}\NormalTok{inc.new <-}\StringTok{ }
\StringTok{    }\NormalTok{forcats}\OperatorTok{::}\KeywordTok{fct_recode}\NormalTok{(nyfs2}\OperatorTok{$}\NormalTok{income.cat3,}
                        \StringTok{"Low"}\NormalTok{ =}\StringTok{ "Low (below 25K)"}\NormalTok{,}
                        \StringTok{"Middle"}\NormalTok{ =}\StringTok{ "Middle (25 - 64K)"}\NormalTok{,}
                        \StringTok{"High"}\NormalTok{ =}\StringTok{ "High (65K or more)"}\NormalTok{)}

\KeywordTok{plot}\NormalTok{(}\KeywordTok{TukeyHSD}\NormalTok{(}\KeywordTok{aov}\NormalTok{(bmi }\OperatorTok{~}\StringTok{ }\NormalTok{inc.new, }\DataTypeTok{data =}\NormalTok{ nyfs2),}
                  \DataTypeTok{conf.level =} \FloatTok{0.90}\NormalTok{))}
\end{Highlighting}
\end{Shaded}

\includegraphics{431-notes_files/figure-latex/unnamed-chunk-239-1.pdf}
