...
```{r EmpRule-fig, echo = FALSE, out.width = '90%', fig.cap = "The Normal Distribution and the Empirical Rule"}
...
```{r kurtosis-fig, echo = FALSE, out.width = '90%', fig.cap = "The Impact of Kurtosis"}
knitr::include_graphics("figures/kurtosis.png")
```

Graphical tools are in most cases the best way to identify issues related to kurtosis. 

## More Detailed Numerical Summaries for Quantitative Variables
...
As mentioned previously, [`DataExplorer`](https://boxuancui.github.io/DataExplorer/) can be used for more automated exploratory data analyses (and don't forget about [`skimr`](https://github.com/ropensci/skimr)) and [`visdat`](http://visdat.njtierney.com/), as well.
